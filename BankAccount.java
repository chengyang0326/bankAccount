...
public class BankAccount {
	...
	// Setter for interestRate.  Note that there are no setters
	//  for the other instance variables!  The owner name and
	//  account type are set at account creation and can't be
	//  changed later.  And the balance is modified via the
	//  deposit and withdraw methods below, rather than a setter.
	...
	public BankAccount(String owner) {
		// this(...) calls the other BankAccount constructor
	...
	public BankAccount(String owner, double initialDeposit, boolean isChecking, double interestRate) {
		...
		// This constructor's parameters share the same names as
		//  BankAccount's instance variables.  To distinguish the
		//  parameters from the instance variables, we put this. 
		//  in front of the instance variable names.
		this.owner = owner;
		...
		// For an initial deposit of $25000 or more, the bank pays
		//  a promotional $200 bonus to the account
		if (initialDeposit >= 25000) {
			balance += 200;
			System.out.format("Initial deposit of $%.2f has earned a promo bonus of $200!\n", initialDeposit);
		}
	}
